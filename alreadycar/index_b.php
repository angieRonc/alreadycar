...
<body>
 ...
 <!-- menu activiades -->
 <a href="#"  title="Gestion Equipos Biomedicos"><ion-icon name="build-outline"></ion-icon><span>Servicios</span></a>

 
 <!-- menu zonas -->
                                
               
 <a href="#" onclick="toggleSubMenu()" title="Buscar Equipo"><ion-icon name="car-sport-outline"></ion-icon><span>Productos</span></a>
 ...
 <!-- menu eventos -->     
<a href="#" title="Revisar Informes"><ion-icon name="business-outline"></ion-icon><span>Talleres</span></a>
 ...
 <!-- menu salir -->
        ...
        <div>
            ...
            <div class="usuario">
                <img src="img/avatart1.jpg" alt="Usuario" title="Usuario">
